...
-->
        <li><?= $this->Html->link(__('カートをチェック'), ['controller' => 'Carts', 'action' => 'check_cart']) ?></li>
    </ul>
</nav>
<div class="products index large-9 medium-8 columns content">
    <!--<h3><?= __('Products') ?></h3>-->
    <h3>商品を選んでカートに入れてください<h3/>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link('カートに入れる', ['controller'=> 'Carts', 'action' => 'into_cart', $product->id]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
