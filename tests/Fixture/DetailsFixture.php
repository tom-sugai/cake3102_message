...
class DetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'order_key' => ['type' => 'foreign', 'columns' => ['order_id'], 'references' => ['orders', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'product_id' => 1,
                'size' => 1,
                'created' => '2022-05-19 05:45:13',
                'modified' => '2022-05-19 05:45:13',
            ],
        ];
        parent::init();
    }
